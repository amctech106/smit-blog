...
const Contact = () => {
    ...
    const form = useRef();
    const { hasCopied, onCopy } = useClipboard('amc.pk106@gmail.com');
                        ...
                        <VStack spacing={{ base: 4, md: 8, lg: 8 }}>
                            ...
                            >
                                <Stack
                                    ...
                                    <Link href="https://github.com/amctech106" target="_blank">
                                    ...
                                    <Link href="https://www.linkedin.com/in/abdul-majeed-0b0bb0a5/" target="_blank">
